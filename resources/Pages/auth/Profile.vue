...
const layout_component_name = computed(() =>
    page.props.user.user_type == "developer" ||
...
function _copySetupKey() {
    ...
    copyText(twofa.setupKey).then(_setupKeyCopied);
}
...
<template>
    <component :is="layout_component_name">
            ...
            <v-row>
                ...
                <v-col cols="12">
                    <v-card class="pa-6" elevation="2">
                        ...
                        <v-switch
                            :label="
                                twofa_active ? '2FA ativado' : '2FA desativado'
                            "
                            ...
                            <template v-else>
                                <div v-if="twofa.qrcode.svg">
                                    ...
                                    >
                                        ...
                                        Authenticator, etc.) para escanear o
                                        código abaixo.
                                    </p>
                                    <div
                                    ...
                                    >
                                        ...
                                        >
                                            Não consegue escanear? Digite esta
                                            chave manualmente no seu aplicativo
                                            autenticador.
                                        </p>
                                        <div
                                    ...
                                    >
                                        ...
                                        aplicativo autenticador para confirmar
                                        que o 2FA está funcionando.
                                    </p>
                        ...
                        <div
                            v-if="
                                twofa.qrcode.svg ||
                                Object.keys(twofa.recovery_codes).length > 0
                            "
                            class="mt-2"
                        >
                            <v-btn
                            ...
                            >
                                ...
                                <p class="text-body-2 mb-3">
                                    ...
                                    Eles podem ser usados caso você perca o
